  ...
  return (
    <div className="w-[100vw] sm:w-[80vw] poemus px-[10px] sm:px-[15px] sm:rounded-[15px] h-[65px] flex items-center justify-between fixed top-[0px] sm:top-[30px]">
      ...
      <ul className="flex items-center gap-[15px] md:gap-[20px]">
        <li className={url[url.length - 1] === "/" || url[url.length - 1] === "#" ? "headitem active" : "headitem"}><Link to="/"><img className="icon" src="/home.png" /></Link></li>
        <li className={url.includes("history") ? "headitem active" : "headitem"}><Link to="/history"><img className="icon" src="/history.png" /></Link></li>
        <li className={url.includes("info") ? "headitem active" : "headitem"}><Link to="/info"><img className="icon" src="/info.png" /></Link></li>
